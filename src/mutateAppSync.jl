...
headers = [
        "x-api-key" => "da2-vxqnpfnpyjgdpag336frvmrkoy"
    ]
...
url = "https://63sork6mwnau7oykuaipt4nquy.appsync-api.us-east-1.amazonaws.com/graphql"
...
body_front = "{\"query\":\"mutation Publish2channel(\$data: AWSJSON!, \$name: String!) {\\n  publish2channel(data: \$data, name: \$name) {\\n    data\\n    name\\n  }\\n}\\n\",\"variables\":{\"name\":\"ruize\",\"data\":\""
